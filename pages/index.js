...
const Home = () => {
  ...
  return (
    <div className="relative bg-white overflow-hidden">
      ...
      <picture className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <source srcSet="/crypto.webp" type="image/webp" />
        <source srcSet="/crypto.jpg" type="image/jpeg" />
        <img
          className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
          src="/crypto.webp"
          alt="crypto currency background"
        />
      </picture>
    </div>
  );
